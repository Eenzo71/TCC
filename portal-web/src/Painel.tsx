      ...
      <header style={styles.navbar}>
        <div style={styles.notificacaoIcon}>
          <img
            src="/images/sino.png"
            alt="Notificações"
            style={styles.iconNotifImg}
          />
        </div>
        <div style={styles.perfil}>
          <img src="/images/user.png" alt="User" style={styles.perfilImg} />
          <span>˅</span>
        </div>
      </header>
      ...
      <section style={styles.gridSistema}>
        ...
        <div style={styles.mapa}>
          <div style={styles.busca}>
            ...
            <img
              src="/images/lupa-buscar.png"
              alt="Buscar"
              style={styles.buscaImg}
            />
          </div>
          <div style={{ ...styles.cardBranco, ...styles.areaMapa }}>
            <h2>Mapa</h2>
          </div>
        </div>
